...
lib.ssMetadata = [
		{name:"PR_IdeaPad_Slim_5i_CM_FIFA_GDN_160x600_atlas_1", frames: [[954,0,50,50],[0,0,160,600],[792,298,160,222],[792,0,160,296],[631,0,159,315],[469,362,147,218],[631,317,150,224],[469,0,160,360],[324,0,143,562],[162,0,160,562]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_IdeaPad_Slim_5i_CM_FIFA_GDN_160x600_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRIdeaPadSlim5iCMFIFAGDN160x600 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(313).call(this.frame_313).wait(17));
	...
	this.timeline.addTween(cjs.Tween.get(this.btn_replay).wait(312).to({_off:false},0).wait(18));
	...
	this.timeline.addTween(cjs.Tween.get(this.mc_mui_ten_xoay).wait(300).to({_off:false},0).to({y:11},12).wait(18));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},300).wait(30));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(300).to({_off:false},0).wait(30));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(251).to({_off:false},0).to({_off:true},49).wait(30));

	// F5
	this.instance_3 = new lib.F5();
	this.instance_3.setTransform(7,72);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(200).to({_off:false},0).to({_off:true},51).wait(79));

	// F4
	this.instance_4 = new lib.F4();
	this.instance_4.setTransform(7,72);
	...
	this.instance_5.setTransform(1,72);
	...
	this.instance_6.setTransform(0,72);
	...
	this.instance_7.setTransform(0,72);
...
// library properties:
lib.properties = {
	id: 'CCFA887B0DC7454BA89A462761540325',
	width: 160,
	height: 600,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_IdeaPad_Slim_5i_CM_FIFA_GDN_160x600_atlas_1.png", id:"PR_IdeaPad_Slim_5i_CM_FIFA_GDN_160x600_atlas_1"}
	],
	preloads: []
};
...
an.compositions['CCFA887B0DC7454BA89A462761540325'] = {
